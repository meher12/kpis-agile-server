...
public class JacocoReportController {
    ...
    public  ResponseEntity<List<JacocoReport>> getAllJacocoReportbyName(@PathVariable ("projectname") String projectname){
    ...
    public ResponseEntity<List<JacocoReport>> addXmlReport(@RequestBody ArrayList<JacocoReport> reportRequest) {
        ...
        for (JacocoReport jacocoReport : reportRequest) {      
         ...
         for (JacocoReport jacocoReport2 : reportRequest) {
             ...
             jacocoReportList.add( new JacocoReport
                     (jacocoReport2.getType(), 
                             jacocoReport2.getProjectname(),
                             jacocoReport2.getCovered(),
                             jacocoReport2.getMissed(),
                              jacocoReport2.getPercentage(), jacocoReport2.getTotalpercentage(), jacocoReport2.getCreatedAt()));
        }
